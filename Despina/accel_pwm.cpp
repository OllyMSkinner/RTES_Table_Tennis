 ...
 *   g++ -std=c++17 -o accel_pwm accel_pwm.cpp -I. -lpthread
 *
...
static constexpr float ACCEL_MIN_G  = 1.0f;   // below this → 0 % (motor off)
static constexpr float ACCEL_MAX_G  = 3.0f;   // above this → 100 % (full buzz)
