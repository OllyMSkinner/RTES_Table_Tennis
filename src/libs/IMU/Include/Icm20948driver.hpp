...
namespace icm20948
{
    ...
    //
    // SOLID design intention:
    // - Single Responsibility:
    //   This class focuses on IMU communication, configuration, and conversion
    //   of raw register data into decoded sensor values.
    // - Encapsulation:
    //   Register access, bank switching, and magnetometer control are hidden
    //   behind a higher-level public API.
    // - Open/Closed:
    //   Client code interacts through configuration objects and high-level
    //   methods, allowing internal implementation details to evolve without
    //   forcing changes on users of the class.
    //
    // Note:
    // This driver necessarily owns several low-level responsibilities because
    // it acts as the hardware abstraction boundary for the IMU device.
    class ICM20948_I2C
    {
    public:
